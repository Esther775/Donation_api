...
User.create(name:"Mike", profile_picture: "no picture yet", email: "mike@mike.com", password: "password", location: "New York", bio: "Im a painter", monthly_donation_amount: "30")
User.create(name:"John Doe", profile_picture: "no picture yet", email: "John@Doe.com", password: "password", location: "Buffalo", bio: "Architect", monthly_donation_amount: "100")
User.create(name:"Jordan", profile_picture: "no picture yet", email: "Jordan@Boardman.com", password: "password", location: "SC", bio: "has a daughter", monthly_donation_amount: "150")
User.create(name:"Esther", profile_picture: "no picture yet", email: "Esther@Morris.com", password: "password", location: "MD", bio: "has a son", monthly_donation_amount: "10")

Catagory.create(name: "Animal")
